...
exports.default = function (protocol, host, path, delay) {
  return new Promise(function (resolve, reject) {
    var dulcetSnapshotRenderCalled = false;
    ...
    _jsdom2.default.env({
      ...
      created: function created(err, window) {
        ...
        window.dulcetSnapshotRender = function () {
          dulcetSnapshotRenderCalled = true;
          setTimeout(function () {
            resolve(window);
          }, delay);
        };
        ...
        if (!dulcetSnapshotRenderCalled) {
          reject("'render' from dulcet-snapshot was never called. Did you replace the call to DulcetDOM.render()?");
        }
      }
    });
  });
